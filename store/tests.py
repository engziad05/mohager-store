import pytest
from store.models import Category, Product, ProductVariant, Cart, CartItem, Order, OrderItem
...
class TestCartModel:
    ...
    def test_order_creation_and_stock_deduction(self):
        ...
        variant = ProductVariant.objects.create(
            product=product, size="XL", color_en="Black", price=450.00, stock=10
        )
        ...
        OrderItem.objects.create(
            order=order, product=product, variant=variant, quantity=quantity_bought, price=variant.price
        )
